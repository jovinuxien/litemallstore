...
const MarketingSection: React.FC = () => {
  ...
  return (
    <>
      <h2 className='mt-4'>Marketing — optional, off by default</h2>
      <p>
...
const Cookies: React.FC = () => (
  <div className='container my-4 lm-doc' style={{ maxWidth: 720 }}>
    ...
    <h2 className='mt-4'>Strictly necessary</h2>
    <p>
    ...
    <h2 className='mt-4'>Analytics — optional, off by default</h2>
    <p>
    ...
    <h2 className='mt-4'>Do Not Track</h2>
    <p>
