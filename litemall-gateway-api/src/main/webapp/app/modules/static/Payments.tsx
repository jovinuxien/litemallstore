...
const Payments: React.FC = () => (
  <div className='container my-4' style={{ maxWidth: 720 }}>
    <h1 className='h4 mb-3'>How payments work</h1>

    <h2 className='h6 mt-4'>Who handles your card</h2>
    ...
    <h2 className='h6 mt-4'>Your bank&apos;s verification step</h2>
    <p className='text-muted small'>
    ...
    <h2 className='h6 mt-4'>What you are charged</h2>
    <p className='text-muted small'>
    ...
    <h2 className='h6 mt-4'>We verify the payment before accepting the order</h2>
    <p className='text-muted small'>
    ...
    <h2 className='h6 mt-4'>Paying from your balance</h2>
    <p className='text-muted small'>
    ...
    <h2 className='h6 mt-4'>Refunds</h2>
    <p className='text-muted small'>
    ...
    <h2 className='h6 mt-4'>What we keep</h2>
    <p className='text-muted small'>
    ...
    <h2 className='h6 mt-4'>If something looks wrong</h2>
    <p className='text-muted small'>
