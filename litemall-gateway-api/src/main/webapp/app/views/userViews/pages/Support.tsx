import IconCalculator from 'bootstrap-icons/icons/calculator.svg';
import IconCart3 from 'bootstrap-icons/icons/cart3.svg';
import IconChatRightText from 'bootstrap-icons/icons/chat-right-text.svg';
import IconJournalCheck from 'bootstrap-icons/icons/journal-check.svg';
import IconNewspaper from 'bootstrap-icons/icons/newspaper.svg';
import IconPersonSquare from 'bootstrap-icons/icons/person-square.svg';
import IconReceiptCutoff from 'bootstrap-icons/icons/receipt-cutoff.svg';
import React, { lazy } from 'react';
import { Link } from 'react-router-dom';

const Search = lazy(() => import('../../../components/userComponents/Search'));
