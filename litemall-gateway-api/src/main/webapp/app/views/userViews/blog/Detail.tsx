...
const Widgets = lazy(() => import('../../../components/userComponents/blog/Widgets'));

const BlogDetailView = () => {
  return (
    <div>
      <div className='card bg-dark text-white rounded-0 mb-3'>
        <img src='../../images/blog/nature-1.webp' className='card-img rounded-0' alt='...' />
        <div className='card-img-overlay text-center'>
          <h1 className='card-title position-absolute bottom-0 mb-3'>It is a long established fact that a reader will be distracted by the readable content</h1>
        </div>
      </div>
      ...
      <div className='container'>
        <div className='row'>
          <div className='col-md-8'>
            <div className='display-6 border-bottom pb-3 mb-1'>Sample blog post</div>
            ...
            <div className='mb-3'>
              <Link to='/' className='badge text-decoration-none bg-warning me-2'>
                #react
              </Link>
              <Link to='/' className='badge text-decoration-none bg-danger me-2'>
                #bootstrap
              </Link>
            ...
            <p>
              Donec ullamcorper nulla non metus auctor fringilla. Nulla vitae elit libero, a pharetra augue. For example, <code>&lt;section&gt;</code> should be
              wrapped as inline.
            </p>
            <ol>
              <li className='fw-bold'>Vestibulum id ligula porta felis euismod semper.</li>
              <li className='fw-bolder'>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</li>
              <li className='font-weight-normal'>Maecenas sed diam eget risus varius blandit sit amet non magna.</li>
              <li className='font-weight-light'>Light weight text.</li>
              <li className='font-weight-lighter'>Lighter weight text (relative to the parent element).</li>
            </ol>
            <img src='../../images/blog/nature-2.webp' className='img-fluid' alt='...' />
            ...
            <div className='mb-3'>
              <pre className='p-2 bg-dark text-white'>
                <code>&lt;p&gt;Sample text here...&lt;/p&gt; &lt;p&gt;And another line of sample text here...&lt;/p&gt;</code>
              </pre>
              <div>
                <var>y</var> = <var>m</var>
                <var>x</var> + <var>b</var>
            ...
            <div className='row mb-3'>
              ...
              <div className='col-md-4'>
                <img src='../../images/blog/nature-thumbnail-1.webp' className='img-thumbnail' alt='...' />
              </div>
            </div>
