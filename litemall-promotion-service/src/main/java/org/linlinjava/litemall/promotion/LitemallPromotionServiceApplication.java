package org.linlinjava.litemall.promotion;
...
public class LitemallPromotionServiceApplication {
    ...
    public LitemallPromotionServiceApplication(Environment env) {
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(LitemallPromotionServiceApplication.class);
    ...
    private static void loadApplicationStartup(Environment environment) {
        ...
        LOGGER.info(
                "\n----------------------------------------------------------\n\t" +
                        "Promotion Service application '{}' is running! Access URLs:\n\t" +
                        "Local: \t\t{}://localhost:{}{}\n\t" +
                        "External: \t{}://{}:{}{}\n\t" +
                        "Profile(s): \t{}\n----------------------------------------------------------",
