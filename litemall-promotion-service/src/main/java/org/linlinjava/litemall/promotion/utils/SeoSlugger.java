 ...
 * THIRD twin of these rules — goods-management carries the Java original
 * ({@code application/seo/SeoSlugger}) and gateway-api a TypeScript copy; change none alone.
 * Wave 17 uses it for the canonical product links in composed Postiz posts.
 *
