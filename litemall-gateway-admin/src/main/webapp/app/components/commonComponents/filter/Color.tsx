    ...
    <div className='card mb-3'>
      ...
      <ul className='list-group list-group-flush show' id='filterColor'>
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input bg-primary' type='checkbox' id='flexCheckColor1' />
            ...
            <div className='form-check col'>
              <input className='form-check-input bg-secondary' type='checkbox' id='flexCheckColor2' />
        ...
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input bg-success' type='checkbox' id='flexCheckColor3' />
            ...
            <div className='form-check col'>
              <input className='form-check-input bg-danger' type='checkbox' id='flexCheckColor4' />
        ...
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input bg-warning' type='checkbox' id='flexCheckColor5' />
              <label className='form-check-label' htmlFor='flexCheckColor5'>
                Yellow <span className='text-muted'>(6)</span>
              </label>
            </div>
            <div className='form-check col'>
              <input className='form-check-input bg-info' type='checkbox' id='flexCheckColor6' />
        ...
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input bg-light' type='checkbox' id='flexCheckColor7' />
              <label className='form-check-label' htmlFor='flexCheckColor7'>
                Light <span className='text-muted'>(3)</span>
              </label>
            </div>
            <div className='form-check col'>
              <input className='form-check-input bg-dark' type='checkbox' id='flexCheckColor8' />
