...
export const getAccount = createAsyncThunk('authentication/get_account', async () => axios.get<any>('srv/private/account'), {
  serializeError: serializeAxiosError,
});

export const logoutServer = createAsyncThunk('authentication/logout', async () => axios.post<any>('srv/logout', {}), {
  serializeError: serializeAxiosError,
});
