  ...
  return (
    <div className='app-container'>
      <div className='lm-placeholder'>
        ...
        <h3>{title}</h3>
        <p>This section is part of the Trovemo admin but is served by another module in this deployment.</p>
        <div className='lm-placeholder-note'>
          Not enabled in this console. The backend for this page lives in the owning service
