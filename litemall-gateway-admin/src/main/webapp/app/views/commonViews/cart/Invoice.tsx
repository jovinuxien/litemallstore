import IconBootstrapFill from 'bootstrap-icons/icons/bootstrap-fill.svg';
      ...
      <div className='bg-white p-5'>
        <div>
          ...
          <div className='row mb-3 pb-3 border-bottom'>
            <div className='col-6'>
              <b className='me-1'>Invoice Date:</b> {new Date(Date.now()).toLocaleDateString()}
            </div>
            <div className='col-6 d-flex justify-content-end'>
          ...
          <div className='text-center mt-4'>
            ...
            <div className='btn-group btn-group-sm d-print-none'>
              ...
              <a href='!#' className='btn btn-light border text-black-50 shadow-none'>
