      ...
      <Card>
        ...
        <CardBody>
          <Alert color='warning'>
            ...
            Apparently, Adblock Plus can remove Font Awesome brand icons with their Remove Social Media Buttons setting. We will not use hacks to force them to
            display. Please
            <a href='https://adblockplus.org/en/bugs' className='alert-link'>
              {' '}
              report an issue with Adblock Plus
            </a>{' '}
            if you believe this to be an error. To work around this, you will need to modify the social icon class names.
          </Alert>
          <Row className='text-center'>
            <Col xs='6' sm='4' md='3' lg='2'>
