import CustomTable from 'app/helpers/CustomTable';
...
const goodsColumns: Array<{ key: keyof Good; header: string; render?: (item: Good) => React.ReactNode }> = [
  { key: 'name', header: 'Product Name' },
  { key: 'price', header: 'Price', render: (item: Good) => `$${item.price.toFixed(2)}` },
  { key: 'stock', header: 'Stock' },
];

const goodsActions = [
  { name: 'Edit', action: (item: Good) => console.log('Edit', item) },
  { name: 'Delete', action: (item: Good) => console.log('Delete', item) },
];
...
const cardChartData1: ChartData<'line'> = {
...
const cardChartData2: ChartData<'line'> = {
  labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July'],
  datasets: [
    {
      label: 'My First dataset',
...
const cardChartOpts2: ChartOptions<'line'> = {
  responsive: true,
  maintainAspectRatio: false,
};

const cardChartOpts1: ChartOptions<'line'> = {
  responsive: true,
  maintainAspectRatio: false,
};

const cardChartOpts3: ChartOptions<'line'> = {
  maintainAspectRatio: false,
};
        ...
        <Col xs='12' sm='6' lg='3'>
          <Card className='text-white bg-primary'>
            ...
            <div className='chart-wrapper px-3' style={{ height: '70px' }}>
              <Line data={cardChartData1} options={cardChartOpts1} />
            </div>
          </Card>
        </Col>
        ...
        <Col>
          <Card>
            ...
            <CardBody>
              <Row>
                ...
                <Col xs='12' md='6' xl='4'>
                  ...
                  <ul className='horizontal-bars type-2'>
                    ...
                    <li className='divider text-center'>
                      <Button color='link' size='sm' className='text-muted' data-toggle='tooltip' data-placement='top' title='' data-original-title='show more'>
                ...
                <Col xs='12' xl='4'>
                  ...
                  <ul className='icons-list'>
                    ...
                    <li className='divider text-center'>
                      <Button color='link' size='sm' className='text-muted' data-toggle='tooltip' data-placement='top' title='show more'>
                        <i className='icon-options' />
                      </Button>
                    </li>
                  </ul>
              ...
              return <CustomTable data={goodsData} columns={goodsColumns} actions={goodsActions} />;
            </CardBody>
          </Card>
        </Col>
      </Row>
