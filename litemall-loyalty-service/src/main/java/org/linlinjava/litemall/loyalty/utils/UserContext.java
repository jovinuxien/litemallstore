...
public class UserContext {
    ...
    public static final String LOYALTY_SERVICE_ID = "tmx-loyalty-service-id";

    private static final ThreadLocal<String> correlationId    = new ThreadLocal<>();
    private static final ThreadLocal<String> authToken        = new ThreadLocal<>();
    private static final ThreadLocal<String> userId           = new ThreadLocal<>();
    private static final ThreadLocal<String> loyaltyServiceId = new ThreadLocal<>();
    ...
    public static String getLoyaltyServiceId() { return loyaltyServiceId.get(); }
    public static void setLoyaltyServiceId(String id) { loyaltyServiceId.set(id); }
