...
public interface LitemallGoodsSpecificationMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallGoodsSpecification row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallGoodsSpecification row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallGoodsSpecification row, @Param("example") LitemallGoodsSpecificationExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallGoodsSpecification row, @Param("example") LitemallGoodsSpecificationExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallGoodsSpecification row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallGoodsSpecification row);
