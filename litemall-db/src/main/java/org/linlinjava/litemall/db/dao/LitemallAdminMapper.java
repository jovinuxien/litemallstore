...
public interface LitemallAdminMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallAdmin row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallAdmin row, @Param("example") LitemallAdminExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallAdmin row, @Param("example") LitemallAdminExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallAdmin row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallAdmin row);
