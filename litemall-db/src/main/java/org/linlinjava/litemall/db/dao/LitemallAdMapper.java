...
public interface LitemallAdMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallAd row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallAd row, @Param("example") LitemallAdExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallAd row, @Param("example") LitemallAdExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallAd row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallAd row);
