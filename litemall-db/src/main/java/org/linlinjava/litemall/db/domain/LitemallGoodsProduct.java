...
public class LitemallGoodsProduct {
    ...
    /**
     * CJ Dropshipping variant id (UUID) for this SKU when the parent goods row is source='cj';
     * null for local SKUs. This is the key litemall-order replays to CJ createOrder.
     * Added by V23__cj_native_linkage.
     */
    private String cjVid;

    /**
     * Hand-maintained (Wave 12): per-variant landed wholesale cost (CJ variant_sell_price,
     * USD basis); column exists since V2 (NOT NULL DEFAULT 0.00). 0.00 means "not captured
     * yet" — margin consumers must render null then, never 0%.
     * Corresponds to litemall_goods_product.cost
     */
    ...
    public String getCjVid() {
        return cjVid;
    }

    public void setCjVid(String cjVid) {
        this.cjVid = cjVid;
    }
    ...
    public static enum Column {
        ...
        cjVid("cj_vid", "cjVid", "VARCHAR", false),
