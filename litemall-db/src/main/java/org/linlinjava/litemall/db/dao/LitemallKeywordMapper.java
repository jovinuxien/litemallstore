...
public interface LitemallKeywordMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallKeyword row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallKeyword row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallKeyword row, @Param("example") LitemallKeywordExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallKeyword row, @Param("example") LitemallKeywordExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallKeyword row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallKeyword row);
