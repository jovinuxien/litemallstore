...
public interface LitemallCartMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallCart row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallCart row, @Param("example") LitemallCartExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallCart row, @Param("example") LitemallCartExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallCart row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallCart row);
