...
public interface LitemallAddressMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallAddress row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallAddress row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallAddress row, @Param("example") LitemallAddressExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallAddress row, @Param("example") LitemallAddressExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallAddress row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallAddress row);
