...
public interface LitemallNoticeAdminMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallNoticeAdmin row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallNoticeAdmin row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallNoticeAdmin row, @Param("example") LitemallNoticeAdminExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallNoticeAdmin row, @Param("example") LitemallNoticeAdminExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallNoticeAdmin row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallNoticeAdmin row);
