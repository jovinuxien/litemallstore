...
public interface LitemallNoticeMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallNotice row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallNotice row, @Param("example") LitemallNoticeExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallNotice row, @Param("example") LitemallNoticeExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallNotice row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallNotice row);
