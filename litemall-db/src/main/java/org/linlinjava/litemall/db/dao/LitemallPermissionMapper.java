...
public interface LitemallPermissionMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallPermission row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallPermission row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallPermission row, @Param("example") LitemallPermissionExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallPermission row, @Param("example") LitemallPermissionExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallPermission row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallPermission row);
