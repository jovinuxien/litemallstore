...
public interface LitemallCommentMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallComment row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallComment row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallComment row, @Param("example") LitemallCommentExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallComment row, @Param("example") LitemallCommentExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallComment row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallComment row);
