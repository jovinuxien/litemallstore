...
public interface LitemallBrandMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallBrand row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallBrand row, @Param("example") LitemallBrandExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallBrand row, @Param("example") LitemallBrandExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallBrand row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallBrand row);
