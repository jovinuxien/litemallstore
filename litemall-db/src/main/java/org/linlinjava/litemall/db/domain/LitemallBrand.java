...
public class LitemallBrand {
    ...
    /**
     * Origin of this brand/store row: 'manual' (admin-created; legacy 'local' rows were
     * normalized by V60), 'cj' (legacy name-keyed CJ brand strings), 'cj-supplier'
     * (AttributionProvider-captured CJ supplier stores), or a future provider name.
     * Added by V23__cj_native_linkage; re-baselined by V60__brand_attribution.
     */
    private String source;

    /**
     * Provider-side identity (e.g. CJ supplierId); NULL for manual rows.
     * UNIQUE together with source. Added by V60__brand_attribution.
     */
    private String externalId;

    /**
     * 0 = consumer brand (renders as "Brand"), 1 = supplier store (renders as "Sold by",
     * never as "Brand"). Added by V60__brand_attribution.
     */
    private Byte kind;

    /**
     * Admin curation gate: provider-captured rows land 0 (linked but never rendered until an
     * admin renames + enables); manual rows are created enabled. Added by V60__brand_attribution.
     */
    private Boolean displayEnabled;

    /**
     * COMPUTED, NOT A COLUMN: on-sale goods linked to this brand/store, attached by
     * {@link org.linlinjava.litemall.db.service.LitemallBrandService#attachGoodsCounts} for list
     * payloads (closes handoff-brand-goods-count.md). Absent (null) unless explicitly attached.
     */
    ...
    public static enum Column {
        ...
        kind("kind", "kind", "TINYINT", false),
        displayEnabled("display_enabled", "displayEnabled", "BIT", false);
