...
public class LitemallComment {
    ...
    /**
     * Hand-maintained (V44). Origin of the review row: 'local' (customer-posted)
     * or 'cj' (ingested from the CJ productComments API).
     * This field corresponds to the database column litemall_comment.source
     */
    private String source;

    /**
     * Hand-maintained (V44). CJ commentId when source='cj' — the idempotent
     * ingest key (unique per source, NULL on local rows).
     * This field corresponds to the database column litemall_comment.external_id
     */
    private String externalId;

    /**
     * Hand-maintained (V44). External reviewer display name (masked by CJ) when
     * source='cj'; local rows resolve the author via litemall_user instead.
     * This field corresponds to the database column litemall_comment.author_name
     */
    private String authorName;

    /**
     * Hand-maintained (V44). External reviewer avatar (CJ country-flag icon URL)
     * when source='cj'.
     * This field corresponds to the database column litemall_comment.author_avatar
     */
    ...
    /** Hand-maintained (V44). @see #source */
    ...
    /** Hand-maintained (V44). @see #externalId */
    ...
    /** Hand-maintained (V44). @see #authorName */
    ...
    /** Hand-maintained (V44). @see #authorAvatar */
    ...
    public static enum Column {
        ...
        authorAvatar("author_avatar", "authorAvatar", "VARCHAR", false);
