...
public interface LitemallStorageMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallStorage row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallStorage row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallStorage row, @Param("example") LitemallStorageExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallStorage row, @Param("example") LitemallStorageExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallStorage row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallStorage row);
