...
public interface LitemallCouponUserMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallCouponUser row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallCouponUser row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallCouponUser row, @Param("example") LitemallCouponUserExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallCouponUser row, @Param("example") LitemallCouponUserExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallCouponUser row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallCouponUser row);
