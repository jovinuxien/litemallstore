...
public interface LitemallSearchHistoryMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallSearchHistory row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallSearchHistory row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallSearchHistory row, @Param("example") LitemallSearchHistoryExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallSearchHistory row, @Param("example") LitemallSearchHistoryExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallSearchHistory row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallSearchHistory row);
