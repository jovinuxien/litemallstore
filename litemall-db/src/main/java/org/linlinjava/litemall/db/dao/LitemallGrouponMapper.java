...
public interface LitemallGrouponMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallGroupon row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallGroupon row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallGroupon row, @Param("example") LitemallGrouponExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallGroupon row, @Param("example") LitemallGrouponExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallGroupon row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallGroupon row);
