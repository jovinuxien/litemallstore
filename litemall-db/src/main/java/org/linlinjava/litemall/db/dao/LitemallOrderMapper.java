...
public interface LitemallOrderMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallOrder row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallOrder row, @Param("example") LitemallOrderExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallOrder row, @Param("example") LitemallOrderExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallOrder row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallOrder row);
