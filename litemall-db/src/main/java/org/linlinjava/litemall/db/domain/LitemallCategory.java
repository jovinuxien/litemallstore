...
public class LitemallCategory {
    ...
    /**
     * Origin of this category: 'local' or 'cj' (mirrored from the CJ Dropshipping category tree).
     * Added by V23__cj_native_linkage.
     */
    private String source;

    /**
     * CJ category id when {@link #source} = 'cj'; null for local categories.
     * Used as the idempotency key when mirroring the CJ category hierarchy.
     */
    private String cjCategoryId;
    ...
    public void setCjCategoryId(String cjCategoryId) {
    ...
    public static enum Column {
        ...
        cjCategoryId("cj_category_id", "cjCategoryId", "VARCHAR", false);
