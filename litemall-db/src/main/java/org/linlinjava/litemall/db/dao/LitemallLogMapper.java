...
public interface LitemallLogMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallLog row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallLog row, @Param("example") LitemallLogExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallLog row, @Param("example") LitemallLogExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallLog row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallLog row);
