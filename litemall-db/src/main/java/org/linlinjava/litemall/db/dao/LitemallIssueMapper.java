...
public interface LitemallIssueMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallIssue row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallIssue row, @Param("example") LitemallIssueExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallIssue row, @Param("example") LitemallIssueExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallIssue row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallIssue row);
