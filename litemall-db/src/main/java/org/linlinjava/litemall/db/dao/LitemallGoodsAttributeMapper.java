...
public interface LitemallGoodsAttributeMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallGoodsAttribute row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallGoodsAttribute row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallGoodsAttribute row, @Param("example") LitemallGoodsAttributeExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallGoodsAttribute row, @Param("example") LitemallGoodsAttributeExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallGoodsAttribute row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallGoodsAttribute row);
