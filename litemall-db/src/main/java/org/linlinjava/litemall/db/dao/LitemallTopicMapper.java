...
public interface LitemallTopicMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallTopic row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallTopic row, @Param("example") LitemallTopicExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("row") LitemallTopic row, @Param("example") LitemallTopicExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallTopic row, @Param("example") LitemallTopicExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallTopic row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeyWithBLOBs(LitemallTopic row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallTopic row);
