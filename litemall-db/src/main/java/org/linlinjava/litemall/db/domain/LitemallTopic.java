...
public class LitemallTopic {
    ...
    /**
     * COMPUTED, NOT A COLUMN: how many of this topic's {@code goods} ids resolve to a live,
     * on-sale, non-deleted product, attached by
     * {@link org.linlinjava.litemall.db.service.LitemallTopicService#attachGoodsCounts} for list
     * payloads (closes handoff-topic-goods-count.md). Absent (null) unless explicitly attached.
     *
     * <p>This is exactly the number of products {@code /srv/topic/detail} will render: that
     * endpoint resolves each id through {@code LitemallGoodsService#findByIdVO}, which filters
     * on-sale and not-deleted. A storefront nav entry driven by this count therefore cannot
