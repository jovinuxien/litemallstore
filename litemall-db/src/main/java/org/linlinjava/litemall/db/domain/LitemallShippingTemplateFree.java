...
/**
 * One free-shipping-threshold row of a freight template (table
 * {@code litemall_shipping_templates_free}, created in V8; {@code country_code} /
 ...
 */
public class LitemallShippingTemplateFree {
    ...
    /** Free-shipping threshold in units (pieces / kg / m3 depending on template type). */
    private BigDecimal number;
    /** Free-shipping order-amount threshold. */
