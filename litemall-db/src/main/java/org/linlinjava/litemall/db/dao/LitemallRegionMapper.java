...
public interface LitemallRegionMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallRegion row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallRegion row, @Param("example") LitemallRegionExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallRegion row, @Param("example") LitemallRegionExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallRegion row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallRegion row);
}