...
public interface LitemallCollectMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallCollect row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallCollect row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallCollect row, @Param("example") LitemallCollectExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallCollect row, @Param("example") LitemallCollectExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallCollect row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallCollect row);
