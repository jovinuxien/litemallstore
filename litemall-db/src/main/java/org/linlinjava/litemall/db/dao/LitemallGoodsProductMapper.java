...
public interface LitemallGoodsProductMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallGoodsProduct row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallGoodsProduct row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallGoodsProduct row, @Param("example") LitemallGoodsProductExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallGoodsProduct row, @Param("example") LitemallGoodsProductExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallGoodsProduct row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallGoodsProduct row);
