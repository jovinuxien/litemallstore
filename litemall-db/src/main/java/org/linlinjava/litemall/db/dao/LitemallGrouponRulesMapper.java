...
public interface LitemallGrouponRulesMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallGrouponRules row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallGrouponRules row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallGrouponRules row, @Param("example") LitemallGrouponRulesExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallGrouponRules row, @Param("example") LitemallGrouponRulesExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallGrouponRules row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallGrouponRules row);
