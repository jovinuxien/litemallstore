...
public interface LitemallSystemMapper {
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallSystem row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallSystem row, @Param("example") LitemallSystemExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallSystem row, @Param("example") LitemallSystemExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallSystem row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallSystem row);
