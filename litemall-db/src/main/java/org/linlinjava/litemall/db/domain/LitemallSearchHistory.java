...
public class LitemallSearchHistory {
    ...
    /**
     * Hand-maintained (V57, Wave 22): total hits this search returned.
     * NULL = unknown (pre-V57 row, or the search failed after the intent was
     * recorded); 0 = a real zero-result search.
     * Corresponds to litemall_search_history.result_count
     */
    ...
    public static enum Column {
        ...
        resultCount("result_count", "resultCount", "INTEGER", false),
