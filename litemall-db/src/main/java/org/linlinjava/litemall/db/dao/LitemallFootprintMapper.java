...
public interface LitemallFootprintMapper {
     ...
     * @mbg.generated
     */
    int insert(LitemallFootprint row);
     ...
     * @mbg.generated
     */
    int insertSelective(LitemallFootprint row);
     ...
     * @mbg.generated
     */
    int updateByExampleSelective(@Param("row") LitemallFootprint row, @Param("example") LitemallFootprintExample example);
     ...
     * @mbg.generated
     */
    int updateByExample(@Param("row") LitemallFootprint row, @Param("example") LitemallFootprintExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeySelective(LitemallFootprint row);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKey(LitemallFootprint row);
