...
public class UserContext {
    ...
    private static final ThreadLocal<String> goodsServiceId = new ThreadLocal<String>();
    ...
    public static String getOrderServiceId() { return goodsServiceId.get(); }
    public static void setGoodsServiceId(String aOrder) {goodsServiceId.set(aOrder);}
