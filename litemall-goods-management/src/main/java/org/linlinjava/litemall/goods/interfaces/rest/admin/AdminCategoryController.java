...
import org.linlinjava.litemall.goods.interfaces.rest.admin.vo.CategoryVo;
...
/**
 * Admin category management, ported from litemall-admin-api ({@code admin.web.AdminCategoryController}).
 * Mounted under {@code /srv/private/admin/**} (ROLE_ADMIN-gated by litemall-svcsecurity).
 */
@RestController
@RequestMapping("/srv/private/admin/category")
@Validated
