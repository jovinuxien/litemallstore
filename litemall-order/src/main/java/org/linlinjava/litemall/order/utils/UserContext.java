...
public class UserContext {
    ...
    private static final ThreadLocal<String> orderServiceId = new ThreadLocal<String>();
    ...
    public static String getOrderServiceId() { return orderServiceId.get(); }
    public static void setOrderServiceId(String aOrder) {orderServiceId.set(aOrder);}
