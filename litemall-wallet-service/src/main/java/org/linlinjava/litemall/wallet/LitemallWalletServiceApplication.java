package org.linlinjava.litemall.wallet;
...
@EnableFeignClients
public class LitemallWalletServiceApplication {

    public static final Logger LOGGER = LoggerFactory.getLogger(LitemallWalletServiceApplication.class);

    private Environment environment;

    public LitemallWalletServiceApplication(Environment env) {
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(LitemallWalletServiceApplication.class);
    ...
    private static void loadApplicationStartup(Environment environment) {
        ...
        LOGGER.info(
                "\n----------------------------------------------------------\n\t" +
                        "Wallet Service application '{}' is running! Access URLs:\n\t" +
                        "Local: \t\t{}://localhost:{}{}\n\t" +
                        "External: \t{}://{}:{}{}\n\t" +
                        "Profile(s): \t{}\n----------------------------------------------------------",
