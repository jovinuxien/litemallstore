...
export const houseFill: JSX.Element = (
...
export const geoAlt: JSX.Element = (
...
export const personFill: JSX.Element = (
...
export const tagFill: JSX.Element = (
...
export const check2: JSX.Element = (
...
export const chatTextFill: JSX.Element = (
...
export const telephoneFill: JSX.Element = (
...
export const phoneFill: JSX.Element = (
...
export const globe2 = (
  <svg width='1em' height='1em' viewBox='0 0 16 16' className='bi bi-globe2' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
    <path
      fillRule='evenodd'
