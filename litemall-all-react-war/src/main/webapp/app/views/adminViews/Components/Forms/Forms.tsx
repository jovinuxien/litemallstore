              ...
              <CardBody>
                <Form action='' method='post' encType='multipart/form-data' className='form-horizontal'>
                  ...
                  <FormGroup row>
                    ...
                    <Col xs='12' md='9'>
                      <Input type='textarea' name='textarea-input' id='textarea-input' placeholder='Content...' />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col md='3'>
              ...
              <CardBody>
                <Form action='' method='post' className='form-horizontal'>
                  <FormGroup row>
                    ...
                    <Col sm='6'>
                      <Input type='text' id='input-small' name='input-small' className='input-sm' placeholder='.form-control-sm' />
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    <Col sm='5'>
                  ...
                  <FormGroup row>
                    ...
                    <Col sm='6'>
                      <Input type='text' id='input-large' name='input-large' className='input-lg' placeholder='.form-control-lg' />
                    </Col>
                  </FormGroup>
                </Form>
              </CardBody>
                ...
                <Form className='form-horizontal'>
                  <FormGroup>
                    ...
                    <div className='controls'>
                      ...
                      <p className='help-block'>Here is some help text</p>
                    </div>
                  </FormGroup>
                  <FormGroup>
                    ...
                    <div className='controls'>
                      ...
                      <span className='help-block'>Here is more help text</span>
                    </div>
                  </FormGroup>
                  <FormGroup>
