    ...
    <div className='card mb-3'>
      ...
      <ul className='list-group list-group-flush show' id='filterSize'>
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input' type='checkbox' id='flexCheckSize1' />
            ...
            <div className='form-check col'>
              <input className='form-check-input' type='checkbox' id='flexCheckSize4' />
        ...
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input' type='checkbox' id='flexCheckSize2' />
            ...
            <div className='form-check col'>
              <input className='form-check-input' type='checkbox' id='flexCheckSize5' />
        ...
        <li className='list-group-item'>
          <div className='row g-0'>
            <div className='form-check col'>
              <input className='form-check-input' type='checkbox' id='flexCheckSize3' />
            ...
            <div className='form-check col'>
              <input className='form-check-input' type='checkbox' id='flexCheckSize6' />
